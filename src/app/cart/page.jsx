    ...
    <div className=" flex justify-between my-10 ">
      <div className="w-3/4">
        {cartItems && cartItems.length > 0 ? (
          <table className="w-full border-collapse">
            <thead>
              <tr className="">
                <th className="bg-blue-100 text-blue-500 px-3 py-3 text-start font-medium">Product</th>
      ...
      <div className="w-1/4">
        <div className="flex flex-col justify-between">
          <h2 className="px-2 py-3 mb-2 text-blue-500 bg-blue-100 font-medium">Order Summary</h2>
